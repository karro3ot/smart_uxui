...
const mediaList = [{text:'[youtube] 아마존으로 2600억 매출', data:'2019.10.22'}, {text:'슈피겐코리아 미국 아마존 독점유통', date:'2019.10.20'}, {text:'[youtube] \'취업비자\' 기업탐방', date:'2019.10.10'}];
// mediaList[0].text
// mediaList[1].date 
