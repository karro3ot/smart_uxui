...
// ========================================
  ...
  let jsUrl = "../js/src/spigen_temp.pc/";

  header.load(tempUrl+'spigen_header.html', function(){
    // body.append('<script src="../js/src/spigen_temp.pc/make_spigen_header_pc.js"></script>');
  });
...
// content =====================================================
  content.load(tempUrl+'spigen_main_content_01.html', function(){
    ...
    // body.append('<script src="../js/src/spigen_temp.pc/make_spigen_content_01.js"></script>');
